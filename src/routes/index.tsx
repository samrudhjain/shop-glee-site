...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Nav */}
      <header className="sticky top-0 z-40 border-b border-border/30 bg-black/40 backdrop-blur-2xl shadow-lg">
      ...
      <section id="home" className="relative overflow-hidden" style={{ background: "var(--gradient-hero)" }}>
        <div className="absolute inset-0 opacity-40 float-animation" style={{ backgroundImage: `url(${heroPhone})`, backgroundSize: "cover", backgroundPosition: "center", maskImage: "radial-gradient(ellipse at center, black 30%, transparent 80%)" }} />
        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2 md:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild size="lg" className="font-semibold text-primary-foreground shadow-[var(--shadow-glow)] transition-all duration-300 hover:scale-105 hover:brightness-110" style={{ background: "var(--gradient-brand)" }}>
      ...
      <section id="featured" className="mx-auto max-w-7xl px-6 py-24">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {featuredProducts.map((p) => (
            <article
              key={p.id}
              className="group relative overflow-hidden rounded-3xl border border-border bg-card/40 backdrop-blur-xl transition-all duration-500 hover:-translate-y-3 hover:rotate-1 hover:border-primary/50 hover:shadow-[var(--shadow-glow)] hover:shadow-[0_0_40px_rgba(255,140,0,0.35)]"
            >
              {/* Image */}
